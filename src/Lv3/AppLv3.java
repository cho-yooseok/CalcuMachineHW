...
public class AppLv3 {
    public static void main(String[] args) {
        ...
        CalculatorLv3 calculatorLv3 = new CalculatorLv3(); // 계산기 객체 생성
        ...
        while (true) { // 무한 루프를 통해 계속 입력받음
            ...
            try {
                calculatorLv3.calculate(num1, num2, operator); // 계산 수행
            ...
            if (deleteOption.equalsIgnoreCase("yes")) {
                calculatorLv3.removeFirstResult(); // 첫 번째 결과 삭제
                System.out.println("첫 번째 연산 결과가 삭제되었습니다.");
            } else if (deleteOption.equalsIgnoreCase("all")) {
                calculatorLv3.clearResults(); // 모든 결과 삭제
            }

            // 현재 저장된 연산 결과 출력
            System.out.println("현재 저장된 연산 결과: ");
            for (String result : calculatorLv3.getResults()) {
